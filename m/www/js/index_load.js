        ...
        $.ajax(url,{
            ...
            success:function(res){
                ...
                $.each(res.info,function(val,index,arr){
                    str += "<div class=\"main2\"> <a href=\"detail.html?id="+index['xiangmu_id']+"\"> <dl> <dt><img src=\""+res.attachurl+"/"+index['thumb']+"\"></dt> <dd> <p class=\"p4\">"+index['title']+"</p><span class=\"s2\">"+index['cat_title']+"</span> <p class=\"p5\">"+index['desc']+"</p> </dd> </dl> </a> <div class=\"rongzi\"> <div class=\"xin\"> <div class=\"left\"> <i class=\"iconfont\">&#xe608;</i><span>"+index['favorites']+"</span> </div> <div class=\"center\"><i class=\"iconfont\">&#xe64b;</i><span>"+index['comments']+"</span></div> <div class=\"right\"><a href=\"detail.html?id="+index['xiangmu_id']+"\" class=\"iconfont\" style=\"color:white;\">&#xe679;</a></div> </div> </div> </div>";
                });
                $(".li_list_1").append(str);
                page++;
                finishedLoadingMore();
            },
            error:function(){
