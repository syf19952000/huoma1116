...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		$.ajax({async:false,type: "GET",url: themedir + "expo/"+settings.theme+"/js/theme.js",dataType: "script",
		...
		if($.browser.msie)
		{
			...
			css.rel="stylesheet";
			css.type="text/css";
			css.href=themedir+"expo/"+settings.theme+"/style/style.css";
		...
		else
		{
			...
			var styCss = "@import url('"+themedir+"expo/"+settings.theme+"/style/style.css');";
