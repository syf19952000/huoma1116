...
class Ctl_Sheji_Shicenter extends Ctl
{
    ...
    public function cases($uid, $case_id,  $page=1)
    {
        $designer = $this->check_designer($uid);
        $pager = $fitler = array();
        $pager['page'] = $page = max((int)$page, 1);
        ...
        if($items = K::M('case/case')->items($filter, null, $page, $limit, $count)){
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('shi:cases', array($uid, '{page}')));
            $this->pagedata['items'] = $items;
        }
    ...
    public function casedetail($case_id)
    {
       ...
       // var_dump($case);die;
        ...
        $this->tmpl = 'sheji/casedetail.html';
    }
    ...
    public function article($uid, $page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;      
        $this->tmpl = 'sheji/shiarticle.html';
    }
    ...
    public function articledetail($article_id)
    {
        ...
        $this->tmpl = 'sheji/articledetail.html';
    }
    ...
    public function comments($uid, $page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;      
        $this->tmpl = 'sheji/shiassess.html';
    }
