 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: tenders.ctl.php 9372 2015-11-26 06:32:36  xinghuali
 */
...
class Ctl_Member_Designer_Tenders extends Ctl_Ucenter
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'mobile:member/designer/tenders/items.html';
    }
    ...
    public function detail($tenders_id=null)
    {
        ...
        if(!$tenders_id = (int)$tenders_id){
            ...
            $this->tmpl = 'mobile:member/designer/tenders/detail.html';
        }
    }
    ...
    public function looked($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/designer/tenders/looks.html';
    }
    ...
    public function tracking($look_id=null, $page=1)
    {
        ...
        if(!$look_id = (int)$look_id){
            ...
            $this->pagedata['pager'] = $pager;
            $this->tmpl = 'mobile:member/designer/tenders/tracking.html';
        }  
    }
