 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: vcate.ctl.php 9372 2015-11-26 06:32:36  xinghuali
 */
...
class Ctl_Member_Shop_Vcate extends Ctl_Ucenter 
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'mobile:member/shop/vcate/items.html';
    }
    ...
    public function create()
    {
        ...
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'mobile:member/shop/vcate/create.html';
        }
    }
    ...
    public function edit($vcat_id=null)
    {
        ...
        if(!($vcat_id = (int)$vcat_id) && !($vcat_id = (int)$this->GP('vcat_id'))){
            ...
            $this->tmpl = 'mobile:member/shop/vcate/edit.html';
        }        
    }
