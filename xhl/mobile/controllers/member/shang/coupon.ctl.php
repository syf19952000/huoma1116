 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: coupon.ctl.php 9372 2015-11-26 06:32:36  xinghuali
 */
...
class Ctl_Member_Shop_Coupon extends Ctl_Ucenter 
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'mobile:member/shop/coupon/items.html';           
    }
        ...
        if(K::M('member/integral')->check('coupon',  $this->MEMBER) === false){
            ...
            if($allow_coupon < 0){
                ...
                if($coupon_id = K::M('shop/coupon')->create($data)){                    
                    ...
                    $this->err->set_data('forward', $this->mklink('member/shop/coupon:index'));
                }
            } 
        }else{
            $this->pagedata['pager'] = $pager;
            $this->tmpl = 'mobile:member/shop/coupon/create.html';
        }
    }
    ...
    public function edit($coupon_id=null)
    {
        ...
        if(!($coupon_id = (int)$coupon_id) && !($coupon_id = (int)$this->GP('coupon_id'))){
            ...
            $this->tmpl = 'mobile:member/shop/coupon/edit.html';
        }       
    }
    ...
    public function downloads($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/shop/coupon/downloads.html';             
    }
    ...
    public function downloadDetail($download_id=null)
    {
        ...
        if(!$download_id = (int)$download_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'mobile:member/shop/coupon/downloadDetail.html';
        }     
    }
