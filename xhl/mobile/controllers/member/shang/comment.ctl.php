...
class Ctl_Member_Shop_Comment extends Ctl_Ucenter 
{
    ...
    public function shop($page=1)
    {
        ...
        $this->tmpl = 'mobile:member/shop/comment/items.html';      
    }
    ...
    public function detail($comment_id=null)
    {
        ...
        if(!($comment_id = (int)$comment_id) && !($comment_id = (int)$this->GP('comment_id'))){
            ...
            $this->tmpl = 'mobile:member/shop/comment/detail.html';
        }
    }
    ...
    public function reply($comment_id=null)
    {
        ...
        if(!($comment_id = (int)$comment_id) && !($comment_id = (int)$this->GP('comment_id'))){
            ...
            $this->tmpl = 'mobile:member/shop/comment/reply.html';
        }
    }
}