 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: team.ctl.php 9372 2015-11-26 06:32:36  xinghuali
 */
...
class Ctl_Member_Company_Team extends Ctl_Ucenter 
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'mobile:member/company/team/items.html';
    }
    ...
    public function bind()
    {
        ...
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'mobile:member/company/team/bind.html';
        }
    }
