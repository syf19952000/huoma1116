 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: youhui.ctl.php 9941 2015-04-28 13:13:58  xinghuali
 */
...
class Ctl_Member_Company_Youhui extends Ctl_Ucenter 
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'mobile:member/company/youhui/items.html';    
    }
        ...
        if(K::M('member/integral')->check('youhui',  $this->MEMBER) === false){
            ...
            if($allow_youhui < 0){
                ...
                if($coupon_id = K::M('company/youhui')->create($data)){
                    ...
                    $this->err->set_data('forward', $this->mklink('member/company/youhui:index'));
                }
            } 
        }else{
            $this->tmpl = 'mobile:member/company/youhui/create.html';
        }
    }
    ...
    public function edit($youhui_id=null)
    {
        ...
        if(!($youhui_id = (int)$youhui_id) && !($youhui_id = (int)$this->GP('youhui_id'))){
            ...
            $this->tmpl = 'mobile:member/company/youhui/edit.html';
        } 
    }
    ...
    public function sign($page=1)
    {
        ...
        $this->tmpl = 'mobile:member/company/youhui/sign.html';
    }
    ...
    public function youhuiSign($youhui_id=null, $page=1)
    {
        ...
        if(!$youhui_id = (int)$youhui_id){
            ...
            $this->pagedata['youhui'] = $youhui;
            $this->tmpl = 'mobile:member/company/youhui/youhuiSign.html';
        }
    }
    ...
    public function signDetail($sign_id=null)
    {
        ...
        if(!$sign_id = (int)$sign_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'mobile:member/company/youhui/signDetail.html';
        }
    }
