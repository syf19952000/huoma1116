 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: mechanic.ctl.php 9941 2015-04-28 13:13:58  xinghuali
 */
...
class Ctl_Member_Mechanic extends Ctl_Ucenter 
{
	...
	public function refresh()
    {
		...
		if($this->GP('fromid')){
			...
			$this->tmpl = 'member/mechanic/refresh/look.html';
		}
	}
    ...
    public function attr()
    {
        ...
        if($attr = $this->checksubmit('attr')){
            ...
            $this->tmpl = 'member/mechanic/attr.html';
        } 
    }
