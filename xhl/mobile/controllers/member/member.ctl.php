...
class Ctl_Member_Member extends Ctl_Ucenter 
{
    ...
    public function info()
    {
        if($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'mobile:member/member/info.html';
        }        
    }
    ...
    public function infos()
    {
        if($account = $this->checksubmit('account')) {
            ...
            $this->pagedata['from_list'] = K::M('member/member')->from_list();
            $this->tmpl = 'mobile:member/member/infos.html';
        }        
    }
    ...
    public function passwd()
    {
        if($account = $this->checksubmit('account')){
           ...
           $this->tmpl = 'mobile:member/member/passwd.html';
        }        
    }
    ...
    public function mail()
    {
        if($account = $this->checksubmit('account')){
           ...
           $this->tmpl = 'mobile:member/member/mail.html';
        }  
    }

    public function face()
    {
        $this->tmpl = 'mobile:member/member/face.html';
    }
    ...
    public function bindaccount()
    {
        ...
        $this->tmpl = 'mobile:member/member/bindaccount.html';
    }
    ...
    public function gold()
    {
        ...
        $this->tmpl = 'mobile:member/member/gold.html';
    }
    ...
    public function logs($type=null, $page=0)
    {
        ...
        $this->tmpl = 'mobile:member/member/logs.html';
    }
	...
	public function listcon($type=null, $page=0)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/member/listcon.html';
    }

    public function chongzhi($type=null, $page=0)
    {
        if(!$page = $this->GP('page')){
            $page=1;
        }
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/member/chongzhi.html';
    }


    public function xiaofei($type=null, $page=0)
        {
            if(!$page = $this->GP('page')){
                $page=1;
            }
            ...
            $this->pagedata['pager'] = $pager;
            $this->tmpl = 'mobile:member/member/xiaofei.html';
        }
    ...
    public function coupon($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/member/coupon.html';
    }

    public function group()
    {
        $this->pagedata['group_list'] = K::M('member/group')->items_by_from($this->MEMBER['from']);
        $this->tmpl = 'mobile:member/member/group/group.html';
    }
