 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: shop.ctl.php 9941 2015-04-28 13:13:58  xinghuali
 */
...
class Ctl_Member_Shop extends Ctl_Ucenter 
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'member/shop/index.html';
    }
    ...
    public function base()
    {
        ...
        if($this->checksubmit()){
            ...
            $this->tmpl = 'member/shop/base.html';
        }        
    }
    ...
    public function skin()
    {
        ...
        if($skin = $this->checksubmit('skin')){
            ...
            $this->tmpl = 'member/shop/skin.html';
        }
    }
    ...
    public function seo()
    {
        ...
        if($data = $this->checksubmit('data')){
            ...
            $this->pagedata['pager'] = $pager;
            $this->tmpl = 'member/shop/seo.html';
        }
    }
    ...
    public function gmsm()
    {
        ...
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'member/shop/gmsm.html';
        }        
    }
	...
	public function refresh()
    {
		...
		if($this->GP('fromid')){
			...
			$this->tmpl = 'member/shop/refresh/look.html';
		}
	}
