...
class Ctl_Member_Weixin extends Ctl_Ucenter 
{
    ...
    public function config()
    {
       ...
       $this->tmpl = 'member/weixin/config.html'; 
    }
    ...
    public function welcome()
    {
        ...
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'member/weixin/welcome.html';
        }        
    }
    ...
    public function leaflets()
    {
        ...
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'member/weixin/leaflets.html';
        }
    }
}