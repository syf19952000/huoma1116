...
class Ctl_Member_Member_Canzhan extends Ctl_Ucenter 
{
    public function canzhan($page=1)
    {
        ...
        $this->tmpl = 'mobile:member/member/canzhan/canzhan.html';
    }
    public function daishenhe($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/member/canzhan/daishenhe.html';
    }
    public function weitongguo($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/member/canzhan/weitongguo.html';
    }
    public function jinxingzhong($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/member/canzhan/jinxingzhong.html';
    }
    public function wancheng($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/member/canzhan/wancheng.html';
    }
		...
		if($data = $this->checksubmit('data')){
		  ...
		  unset($data['filesname']);
           if($id = K::M('canzhan/canzhan')->create($data)){
            ...
            $this->tmpl = 'mobile:member/member/canzhan/create.html';
        }        
    }
    ...
    public function canzhanfile($cid=null, $page=1)
    {
        ...
        if (!($cid = (int) $cid) && !($cid = (int)$this->GP('cid'))) {
            ...
            $this->pagedata['pager'] = $pager;
            $this->tmpl = 'mobile:member/member/canzhan/canzhanfile.html';
        }        
    }
    ...
    public function canzhanDetail($id=null)
    {
        if(!$id = (int)$id){
            ...
            $this->tmpl = 'mobile:member/member/canzhan/canzhanDetail.html';
        }
    }
    ...
    public function selectdashejishi($id=0,$page=1)
    {
		...
		$pager['id'] = $id;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'mobile:member/member/canzhan/selectdashejishi.html';
    }
...
//						$this->err->set_data('forward', '?canzhan/canzhan-detail-'.$id.'.html');
    ...
    public function canzhanEdit($id=null)
    {
        if(!($id = (int)$id) && !($id = (int)$this->GP('id'))){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'mobile:member/member/canzhan/canzhanEdit.html';
        }        
    }
    ...
    public function company($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;        
        $this->tmpl = 'mobile:member/member/canzhan/company.html';
    }
    ...
    public function companyDetail($yuyue_id=null)
    {
        if(!$yuyue_id = (int)$yuyue_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'mobile:member/member/canzhan/companyDetail.html';
        }
    }
    ...
    public function designer($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;        
        $this->tmpl = 'mobile:member/member/canzhan/designer.html';
    }
    ...
    public function designerDetail($yuyue_id=null)
    {
        if(!$yuyue_id = (int)$yuyue_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'mobile:member/member/canzhan/designerDetail.html';
        }
    }
    ...
    public function mechanic($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;        
        $this->tmpl = 'mobile:member/member/canzhan/mechanic.html';
    }
    ...
    public function mechanicDetail($yuyue_id=null)
    {
        if(!$yuyue_id = (int)$yuyue_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'mobile:member/member/canzhan/mechanicDetail.html';
        }
    }
    ...
    public function shop($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;        
        $this->tmpl = 'mobile:member/member/canzhan/shop.html';
    }
    ...
    public function shopDetail($yuyue_id=null)
    {
        if(!$yuyue_id = (int)$yuyue_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'mobile:member/member/canzhan/shopDetail.html';
        }        
    }
