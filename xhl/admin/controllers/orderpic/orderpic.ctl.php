...
class Ctl_Orderpic_Orderpic extends Ctl
{
    public function index($page=1)
    {
        ...
        if($items = K::M('case/case')->items_order($filter, array(), $page, $limit, $count)){
        	$pager['count'] = $count;
        ...
        $this->tmpl = 'admin:orderpic/orderpic/items.html';
    }
	...
	public function dialog($page=1)
    {
        ...
        $this->tmpl = 'admin:chao/chao/dialog.html';         
    }
    ...
    public function audit($page=1)
    {
        ...
        $pager['page'] = max(intval($page), 1);
        $pager['limit'] = $limit = 50;
        $filter = array('tzaudit'=>0, 'closed'=>0, 'istz'=>1); 
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'admin:chao/chao/audit.html';
    }
    ...
    public function so()
    {
        $this->tmpl = 'admin:chao/chao/so.html';
    }
    ...
    public function detail($case_id=null)
    {
        if(!$case_id = (int)$case_id){
            ...
            $this->tmpl = 'admin:chao/chao/detail.html';
        }
    }
    ...
    {	
        if($this->checksubmit()){
           ...
           $this->tmpl = 'admin:chao/chao/create.html';
        }
    }
    ...
    public function edit($case_id=null)
    {
        if(!($case_id = (int)$case_id) && !($case_id = $this->GP('case_id'))){
            ...
            $this->pagedata['detail'] = $detail;            
        	$this->tmpl = 'admin:chao/chao/edit.html';
        }
    }
