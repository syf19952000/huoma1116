 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: comment.ctl.php 2016-09-27 02:07:36  xinghuali
 */
if (!defined('__CORE_DIR')) {
    exit("Access Denied");
}

class Ctl_Chao_Comment extends Ctl {
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'admin:chao/comment/items.html';
    }

    public function so()
    {
        $this->tmpl = 'admin:chao/comment/so.html';
    }
    ...
    public function create()
    {
        if ($this->checksubmit()) {
            ...
            $this->tmpl = 'admin:chao/comment/create.html';
        }
    ...
    public function edit($comment_id = null)
    {
        if (!($comment_id = (int) $comment_id) && !($comment_id = $this->GP('comment_id'))) {
            ...
            $this->tmpl = 'admin:chao/comment/edit.html';
        }
    }
