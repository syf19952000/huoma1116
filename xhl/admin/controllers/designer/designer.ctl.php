 ...
 * 人要活得优雅,代码更需要优雅
 * $Id: designer.ctl.php 2016-09-27 02:07:36  xinghuali
 */
...
class Ctl_Designer_Designer extends Ctl
{
    ...
    public function dialog($page=1)
    {
        ...
        if($items = K::M('designer/designer')->items($filter, array('is_qian'=>'DESC','orderby'=>'ASC'), $page, $limit, $count)){
            $pager['count'] = $count;
