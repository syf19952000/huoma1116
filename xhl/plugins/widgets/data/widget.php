...
class Widget_Data extends Model
{
    ...
    public function region2(&$params)
    {
        if(!$params['tpl']){
            $params['tpl'] = 'widget:data/region2.html';
        }
        $area_id = $city_id = $province_id = 0;
        $area_id = (int)$params['area_id'];
        $city_id = (int)$params['city_id'];
    ...
    public function region3(&$params)
    {
        if(!$params['tpl']){
            $params['tpl'] = 'widget:data/region3.html';
        }
        $area_id = $city_id = $province_id = 0;
        $area_id = (int)$params['area_id'];
        $city_id = (int)$params['city_id'];
    ...
    public function cz_city(&$params)
    {
		if(!$params['tpl']){
            $params['tpl'] = 'widget:data/cz_city.html';
        }
		 $city_id = (int)$params['city_id'];
        	include(dirname(dirname(dirname(dirname(__FILE__)))).'/data/array/array.php'); 
			$cz_city_html = '';
			$data['cz_city'] = $cz_city;
			$data['city_id'] = $city_id;
        return $data;       
    }
