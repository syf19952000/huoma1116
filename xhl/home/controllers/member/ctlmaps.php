...
array(
    ...
    'designer' => array( 
        ...
        array('title'=>'帐户管理', 'menu'=>true,'biao'=>'icon-people',
            'items'=>array(
                array('title'=>'个人中心', 'ctl'=>'member/designer:index', 'menu'=>true),
//                array('title'=>'发起项目', 'ctl'=>'member/publish:index', 'menu'=>true),
        ...
        array('title'=>'团队', 'menu'=>true,
            'items'=>array(
                ...
                array('title'=>'解决方案', 'ctl'=>'member/sheji/project:index', 'menu'=>true),
                array('title'=>'添加解决方案', 'ctl'=>'member/sheji/project:create', 'nav'=>'member/sheji/project:index'),
                array('title'=>'编辑解决方案', 'ctl'=>'member/sheji/project:edit', 'nav'=>'member/sheji/project:index'),
                array('title'=>'删除解决方案', 'ctl'=>'member/sheji/project:delete', 'nav'=>'member/sheji/project:index'),
                 array('title'=>'下载文件', 'ctl'=>'member/sheji/zhantai:ajaxpic', 'nav'=>'member/sheji/zhantai:index'),
            )
        ),
        array('title'=>'个人', 'menu'=>true,
            'items'=>array(
