...
class Ctl_Member_Member_Yuyue extends Ctl_Ucenter 
{
    ...
    public function tenders($page=1)
    {
        ...
        $this->tmpl = 'member/member/yuyue/tenders.html';
    }
    ...
    public function tendersDetail($tenders_id=null)
    {
        if(!$tenders_id = (int)$tenders_id){
            ...
            $this->tmpl = 'member/member/yuyue/tendersDetail.html';
        }
    }
    ...
    public function tendersEdit($tenders_id=null)
    {
        if(!($tenders_id = (int)$tenders_id) && !($tenders_id = (int)$this->GP('tenders_id'))){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'member/member/yuyue/tendersEdit.html';
        }        
    }
    ...
    public function company($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;        
        $this->tmpl = 'member/member/yuyue/company.html';
    }
    ...
    public function companyDetail($yuyue_id=null)
    {
        if(!$yuyue_id = (int)$yuyue_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'member/member/yuyue/companyDetail.html';
        }
    }
    ...
    public function designer($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;        
        $this->tmpl = 'member/member/yuyue/designer.html';
    }
    ...
    public function designerDetail($yuyue_id=null)
    {
        if(!$yuyue_id = (int)$yuyue_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'member/member/yuyue/designerDetail.html';
        }
    }
    ...
    public function mechanic($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;        
        $this->tmpl = 'member/member/yuyue/mechanic.html';
    }
    ...
    public function mechanicDetail($yuyue_id=null)
    {
        if(!$yuyue_id = (int)$yuyue_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'member/member/yuyue/mechanicDetail.html';
        }
    }
    ...
    public function shop($page=1)
    {
        ...
        $this->pagedata['pager'] = $pager;        
        $this->tmpl = 'member/member/yuyue/shop.html';
    }
    ...
    public function shopDetail($yuyue_id=null)
    {
        if(!$yuyue_id = (int)$yuyue_id){
            ...
            $this->pagedata['detail'] = $detail;
            $this->tmpl = 'member/member/yuyue/shopDetail.html';
        }        
    }
