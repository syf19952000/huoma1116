...
class Ctl_Member_Product_Comment extends Ctl_Ucenter 
{
    ...
    public function shop($page=1)
    {
        ...
        $this->tmpl = 'member/product/comment/items.html';      
    }
    ...
    public function detail($comment_id=null)
    {
        ...
        if(!($comment_id = (int)$comment_id) && !($comment_id = (int)$this->GP('comment_id'))){
            ...
            $this->tmpl = 'member/product/comment/detail.html';
        }
    }
    ...
    public function reply($comment_id=null)
    {
        ...
        if(!($comment_id = (int)$comment_id) && !($comment_id = (int)$this->GP('comment_id'))){
            ...
            $this->tmpl = 'member/shop/comment/reply.html';
        }
    }
}