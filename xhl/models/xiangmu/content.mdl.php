...
class Mdl_Xiangmu_Content extends Mdl_Table
{   
  
    protected $_table = 'xiangmu_content';
    protected $_pk = 'xiangmu_id';
    protected $_cols = 'xiangmu_id,seo_title,seo_keywords,seo_description,content,clientip';
