 ...
 * $Id: article.mdl.php 9581 2015-04-08 13:25:34Z maoge $
 */
...
{   
    ...
    public function article_all()
    {
        ...
        $sql = "SELECT * FROM ".$this->table($this->_table)."  order by article_id desc ";
...
<<<<<<< HEAD
           ...
           foreach ($items as $kk => $vv) {
            $sql2 = "SELECT count(*) FROM  xhl_article_collect where article_id = ".$vv['article_id'];
            ...
            $sql2 = "SELECT count(*) FROM  xhl_article_comment where article_id = ".$vvv['article_id'];
            $str = $this->db->Execute($sql2);
            while($row = $str->fetch()){
                  $collect = $row;
            }
...
>>>>>>> d2a31ff35db971065813ae1c59dd238b6ff6aa58
     ...
     public function zonghe_all()
    {

        $sql = "SELECT * FROM ".$this->table($this->_table)."  order by article_id desc,orderby desc ";
           if($rs = $this->db->Execute($sql)){
                while($row = $rs->fetch()){
                  $items[$row[$this->_pk]] = $row;
                }
