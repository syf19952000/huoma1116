 ...
 * $Id: mysql.mdl.php 2016-09-27 02:07:36  xinghuali
 */
...
//		exit;
    ...
    public function echo_insert($table, $data, $return_insert_id=false, $replace=false)
    {
        $sql = $this->_insert_sql($data);
        $cmd = $replace ? 'REPLACE INTO' : 'INSERT INTO';
        $table = $this->table($table);
    ...
    public function update($table, $data, $condition, $affected_rows=false, $low_priority=false)
    {
        ...
        $table = $this->table($table);
//		echo "$cmd $table SET $sql WHERE $where";
//		exit;
